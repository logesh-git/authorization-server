...
public class MfaTokenGranter extends AbstractTokenGranter {
    ...
    protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
        ...
        if (mfaToken != null) {
            ...
            if (parameters.containsKey("mfa_code")) {
                String code = String.valueOf(parseCode(parameters.get("mfa_code")));
    ...
    private OAuth2Authentication getAuthentication(TokenRequest tokenRequest, OAuth2Authentication authentication) {
        ...
        Authentication user= new UsernamePasswordAuthenticationToken(authentication.getPrincipal(),authentication.getCredentials(),authentication.getAuthorities());
